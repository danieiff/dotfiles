...
// grapheme ('🧑‍💻' (technologist)) is simply ignored here. Instead, use 'send_unicode_string()' for grapheme.
// const graphemes = [];
...
const file = dirname(fileURLToPath(import.meta.url)) + "/user_unicode_map.h";
