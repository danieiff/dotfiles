local colors = {
  ...
  StatusLine = { fg = "#444444", bg = "#C4C4C4" },
  ...
  StatuslineModeNormal = { link = 'StatusLine' },
  StatuslineModeVisual = { bg = '#87afaf' },
  StatuslineModeInsert = { bg = '#d7afaf' },
  StatuslineModeReplace = { bg = '#87af87' },
  StatuslineModeCommand = { bg = '#e8e8d3' },
  StatuslineModeOther = { bg = '#e8e8d3' }
}

vim.cmd("highlight clear | let g:colors_name='my_theme'")
